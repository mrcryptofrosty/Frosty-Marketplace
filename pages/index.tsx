...
const Home: NextPage = () => {
  ...
  const marketplace = useMarketplace(
    "0xb6F2A3f0310AbEca1B204CB0D21996Cf35344568" // Your marketplace contract address here
  );
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        {/* Top Section */}
        <h1 className={styles.h1}>Frosty NFT Marketplace</h1>
        <p className={styles.explain}>
          A peer to peer marketpace powered by  {" "}
          <b>
            {" "}
            <a
